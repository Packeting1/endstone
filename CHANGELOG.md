...
- Added the `ClockTimeSkipEvent` API for cancellable level clock advances, exposing command, custom and night-skip reasons and a mutable signed skip amount.
...
- Added `TimeSkipEvent` for representing when the time of a level is skipped.
