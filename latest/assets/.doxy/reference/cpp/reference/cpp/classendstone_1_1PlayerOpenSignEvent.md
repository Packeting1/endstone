...
|   | [**PlayerOpenSignEvent**](#function-playeropensignevent) ([**const**](classendstone_1_1Identifier.md) [**NotNull**](classendstone_1_1NotNull.md)&lt; [**Player**](classendstone_1_1Player.md) &gt; & player, [**Sign**](classendstone_1_1Sign.md) & sign, [**Sign::Side**](classendstone_1_1Sign.md#enum-side) side, [**Cause**](classendstone_1_1PlayerOpenSignEvent.md#enum-cause) cause) <br> |
...
|  [**Sign**](classendstone_1_1Sign.md) & | [**getSign**](#function-getsign) () const<br>_Gets a captured state of the sign involved in this event._  |
...
```C++
inline Sign & endstone::PlayerOpenSignEvent::getSign () const
```



Changes to the sign are kept in the captured state until [**Sign::update()**](classendstone_1_1BlockState.md#function-update-13) is called.
