...
# Class endstone::PlayerGlideEvent



[**ClassList**](annotated.md) **>** [**endstone**](namespaceendstone.md) **>** [**PlayerGlideEvent**](classendstone_1_1PlayerGlideEvent.md)
...
| Type | Name |
| ---: | :--- |
|   | [**PlayerGlideEvent**](#function-playerglideevent) ([**Player**](classendstone_1_1Player.md) & player, [**bool**](classendstone_1_1Identifier.md) gliding) <br> |
...
### function PlayerGlideEvent 

```C++
inline explicit endstone::PlayerGlideEvent::PlayerGlideEvent (
    Player & player,
    bool gliding
) 
```
...
```C++
inline bool endstone::PlayerGlideEvent::isGliding () const
```
...
------------------------------
The documentation for this class was generated from the following file `include/endstone/event/player/player_glide_event.h`
