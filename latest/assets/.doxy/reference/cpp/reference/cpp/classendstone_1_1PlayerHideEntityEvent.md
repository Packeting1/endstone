...
# Class endstone::PlayerHideEntityEvent



[**ClassList**](annotated.md) **>** [**endstone**](namespaceendstone.md) **>** [**PlayerHideEntityEvent**](classendstone_1_1PlayerHideEntityEvent.md)
...
| Type | Name |
| ---: | :--- |
|   | [**ENDSTONE\_EVENT**](#function-endstone_event) ([**PlayerHideEntityEvent**](classendstone_1_1PlayerHideEntityEvent.md)) <br> |
|   | [**PlayerHideEntityEvent**](#function-playerhideentityevent) ([**const**](classendstone_1_1Identifier.md) [**NotNull**](classendstone_1_1NotNull.md)&lt; [**Player**](classendstone_1_1Player.md) &gt; & player, [**const**](classendstone_1_1Identifier.md) [**NotNull**](classendstone_1_1NotNull.md)&lt; [**Actor**](classendstone_1_1Actor.md) &gt; & entity) <br> |
|  [**const**](classendstone_1_1Identifier.md) [**NotNull**](classendstone_1_1NotNull.md)&lt; [**Actor**](classendstone_1_1Actor.md) &gt; & | [**getEntity**](#function-getentity) () const<br>_Gets the actor hidden from the player._  |
...
**See also:** [**Player::hideEntity()**](classendstone_1_1Player.md#function-hideentity) 
...
```C++
endstone::PlayerHideEntityEvent::ENDSTONE_EVENT (
...
### function PlayerHideEntityEvent 

```C++
inline endstone::PlayerHideEntityEvent::PlayerHideEntityEvent (
...
```C++
inline const  NotNull < Actor > & endstone::PlayerHideEntityEvent::getEntity () const
```
...
------------------------------
The documentation for this class was generated from the following file `include/endstone/event/player/player_hide_entity_event.h`
