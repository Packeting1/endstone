...
# Class endstone::PlayerToggleSwimEvent



[**ClassList**](annotated.md) **>** [**endstone**](namespaceendstone.md) **>** [**PlayerToggleSwimEvent**](classendstone_1_1PlayerToggleSwimEvent.md)
...
| Type | Name |
| ---: | :--- |
|   | [**PlayerToggleSwimEvent**](#function-playertoggleswimevent) ([**const**](classendstone_1_1Identifier.md) [**NotNull**](classendstone_1_1NotNull.md)&lt; [**Player**](classendstone_1_1Player.md) &gt; & player, [**bool**](classendstone_1_1Identifier.md) swimming) <br> |
...
### function PlayerToggleSwimEvent 

```C++
inline explicit endstone::PlayerToggleSwimEvent::PlayerToggleSwimEvent (
...
------------------------------
The documentation for this class was generated from the following file `include/endstone/event/player/player_toggle_swim_event.h`
