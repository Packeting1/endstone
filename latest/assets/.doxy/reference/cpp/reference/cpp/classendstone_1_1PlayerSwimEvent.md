...
# Class endstone::PlayerSwimEvent



[**ClassList**](annotated.md) **>** [**endstone**](namespaceendstone.md) **>** [**PlayerSwimEvent**](classendstone_1_1PlayerSwimEvent.md)
...
| Type | Name |
| ---: | :--- |
|   | [**PlayerSwimEvent**](#function-playerswimevent) ([**Player**](classendstone_1_1Player.md) & player, [**bool**](classendstone_1_1Identifier.md) swimming) <br> |
...
### function PlayerSwimEvent 

```C++
inline explicit endstone::PlayerSwimEvent::PlayerSwimEvent (
    Player & player,
    bool swimming
) 
```
...
```C++
inline bool endstone::PlayerSwimEvent::isSwimming () const
```
...
------------------------------
The documentation for this class was generated from the following file `include/endstone/event/player/player_swim_event.h`
