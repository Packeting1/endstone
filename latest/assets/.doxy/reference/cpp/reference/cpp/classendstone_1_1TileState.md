...
# Class endstone::TileState



[**ClassList**](annotated.md) **>** [**endstone**](namespaceendstone.md) **>** [**TileState**](classendstone_1_1TileState.md)
...
|   | [**~TileState**](#function-tilestate) () override<br> |
...
```C++
virtual bool endstone::TileState::isSnapshot () const = 0
```
...
```C++
endstone::TileState::~TileState () override
```
...
------------------------------
The documentation for this class was generated from the following file `include/endstone/block/tile_state.h`
