...
# Class endstone::PlayerShowEntityEvent



[**ClassList**](annotated.md) **>** [**endstone**](namespaceendstone.md) **>** [**PlayerShowEntityEvent**](classendstone_1_1PlayerShowEntityEvent.md)
...
| Type | Name |
| ---: | :--- |
|   | [**ENDSTONE\_EVENT**](#function-endstone_event) ([**PlayerShowEntityEvent**](classendstone_1_1PlayerShowEntityEvent.md)) <br> |
|   | [**PlayerShowEntityEvent**](#function-playershowentityevent) ([**const**](classendstone_1_1Identifier.md) [**NotNull**](classendstone_1_1NotNull.md)&lt; [**Player**](classendstone_1_1Player.md) &gt; & player, [**Actor**](classendstone_1_1Actor.md) & entity) <br> |
|  [**Actor**](classendstone_1_1Actor.md) & | [**getEntity**](#function-getentity) () const<br>_Gets the actor shown to the player._  |
...
**See also:** [**Player::showEntity()**](classendstone_1_1Player.md#function-showentity) 
...
```C++
endstone::PlayerShowEntityEvent::ENDSTONE_EVENT (
...
### function PlayerShowEntityEvent 

```C++
inline endstone::PlayerShowEntityEvent::PlayerShowEntityEvent (
...
```C++
inline Actor & endstone::PlayerShowEntityEvent::getEntity () const
```
...
------------------------------
The documentation for this class was generated from the following file `include/endstone/event/player/player_show_entity_event.h`
